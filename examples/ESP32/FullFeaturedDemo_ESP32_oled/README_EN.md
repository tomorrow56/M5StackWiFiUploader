# ESP32 WiFi File Uploader - Full Featured Demo (OLED Version)

This is a full-featured demo sketch for ESP32 WiFi file uploader with OLED display support. It provides HTTP and WebSocket servers, enables file uploads to SD card, real-time progress display, LED status indicators, and **0.91-inch OLED display for system status visualization**.
...
```cpp
// OLED Display settings (FullFeaturedDemo_ESP32_oled.ino lines 50-55)
...
// SD card SPI settings (FullFeaturedDemo_ESP32_oled.ino lines 62-65)
...
// LED settings (FullFeaturedDemo_ESP32_oled.ino lines 70-71)
...
```cpp
// FullFeaturedDemo_ESP32_oled.ino line 28
...
**Current Settings (FullFeaturedDemo_ESP32_oled.ino lines 277-284):**
```cpp
// Allowed extensions
...
**Special Feature**: 0.91-inch OLED display support
